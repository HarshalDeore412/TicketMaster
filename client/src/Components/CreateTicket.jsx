...
function RaiseTicketForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (localStorage.getItem('token')) {
      try {
        const response = await fetch('http://localhost:4000/api/ticket/create-ticket', {
          method: 'POST',
          headers: {
  ...
  return (
    <div className="max-w-2xl border-2 mx-auto p-4 md:p-6 lg:p-8 bg-white rounded-lg shadow-md">
...
// {
//   "deskNo": "D123",
//   "issue": "Computer not turning on",
//   "description": "My computer is not turning on. I've tried pressing the power button several times."
// }


// This code creates a responsive form using Tailwind CSS that allows users to raise a ticket by providing their desk number, issue, and description. The form submits a POST request to the /api/tickets endpoint with the provided data.

// Make sure to install Tailwind CSS and import it in your JSX file:
